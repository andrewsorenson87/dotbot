...
export myHome="/Users/andrew.sorenson"
# don't put duplicate lines or lines starting with space in the history.
# See bash(1) for more options
HISTCONTROL=ignoreboth
PHPRC=/usr/local/etc/php/7.0/php-cli.ini
MAPIWP="$myHome/src/mapi-server/public/wp-updates"
etc=/usr/local/etc
...
HISTSIZE=1000
HISTFILESIZE=2000
export PATH="/usr/local/opt/coreutils/libexec/gnubin:$PATH:$myHome/bin:./vendor/bin:./node_modules/.bin:$myHome/.composer/vendor/bin"
...
MAPIDIR="$myHome/src/mapi-server"
...
alias frontier="cd $myHome/src/cms-v2/trunk/sites/partners.frontier"
alias src="cd ~/src"
alias phpx="$PHPX"
alias pu="phpunit"
